...
export class TestSetupUtil {
   ...
   */
  async setupAccessibilityTest(page: Page, options: TestSetupOptions = {}): Promise<void> {
    const {
  ...
  private async setupAccessibilityPageConfig(page: Page): Promise<void> {
    ...
    await page.setExtraHTTPHeaders({
      'User-Agent':
        'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36 AccessibilityTester/1.0',
    });
