/**
 * Interface for error results returned by service operations
 */
...
/**
 * Interface for successful results returned by service operations
 * @template T Type of the data returned on success
 */
export interface SuccessResult<T = any> {
  /** Always true for success results */
  success: true;
  /** Data returned by the successful operation */
  data: T;
